  ...
  >
    <section class="px-10">
      ...
      <form @submit.prevent="signIn" novalidate>
        <h1 class="mb-4 text-xl text-white font-bold">LOG IN</h1>
        <!--- Email ----->
        <label
        ...
        <div class="relative">
          ...
          <input
            type="text"
            id="email"
            class="text-sm py-2.5 px-5 pl-10 p-2.5 rounded w-80 border-2 border-amber-500 focus:outline-none"
    ...
    <!--- SOCIAL LOGIN'S ----->
    <section class="flex flex-col w-72 pr-10" >
      <h1 class="mb-4 text-xl text-white font-bold uppercase">with social account</h1>
      <button
        type="button"
